...
### Things that is have learnt

need to specify a workdir using WORKDIR
-  need to copy the whole directory rather than the just the pom file
- the jar file is created in the directory named "target".
